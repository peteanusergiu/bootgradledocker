...
/**
 * This code defines the HTTP status codes returned by SPICA.
 */
public enum ReturnCode {
     ...
     * Service error.
     */
    CORE_SERVICE_ERROR(500, "Core Service Error"),
    /**
     * Service timeout.
     */
    CORE_SERVICE_TIMEOUT(500, "Core Service Timeout");
     ...
     */
    ReturnCode(int httpCode, String message){
        this.httpCode = httpCode;
        this.message = message;
    }

    public static ReturnCode fromHttpCode(int httpCode){
        for (ReturnCode returnCode : ReturnCode.values()) {
            if(returnCode.getHttpCode() == httpCode){
                return returnCode;
            }
        }
